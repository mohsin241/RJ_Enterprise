          ...
          <div className="lg:w-1/2 bg-primary p-8 text-white">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.indiamart.com/r-j-enterprisevasaivirar/" aria-label="IndiaMART" className="bg-white/10 pl-2 hover:bg-white/20 w-10 h-10 rounded-full flex items-center transition">
